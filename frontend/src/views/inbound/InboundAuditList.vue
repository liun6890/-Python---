...
const approve = async (row) => {
  await request({ url: '/inbound/orders', method: 'put', data: { id: row.id, action: 'approve' } })
...
const reject = async (row) => {
  ...
  await request({ url: '/inbound/orders', method: 'put', data: { id: row.id, action: 'reject', reject_reason: value } })
